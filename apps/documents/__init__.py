...
document_viewer = {'text':_('viewer'), 'view':'document_viewer', 'args':'object.id', 'famfam':'page', 'permissions':{'namespace':'documents', 'permissions':[PERMISSION_DOCUMENT_VIEW]}}
...
register_links(Document, [document_viewer])
